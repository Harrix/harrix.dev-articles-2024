...
Однако VScode всё равно надо научить запускать самостоятельно нужное виртуальное окружение. Но об этом ниже в следующем разделе.
...
Проверим, что VSCode правильно подхватил виртуальное окружение `.venv`. Для этого смотрим внизу справа, как на рисунке ниже. Если там общее виртуальное окружение показано, то нажимаем на него и выбираем наше окружение:
