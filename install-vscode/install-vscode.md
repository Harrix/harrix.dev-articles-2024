...
permalink: https://harrix.dev/ru/articles/2024/install-vscode/
lang: ru
attribution:
...
![Выбор установленной темы](img/theme_03.png)
...
Для запуска тестов есть отдельная вкладка:

![Вкладка тестирования](img/test_01.png)

_Рисунок 122 — Вкладка тестирования_

Вначале предложат сконфигурировать тесты, выбрав вашу библиотеку для тестирования:

![Выбор unittest или pytest](img/test_02.png)

_Рисунок 123 — Выбор unittest или pytest_

Выбор папки для тестирования:

![Папка tests](img/test_03.png)

_Рисунок 124 — Папка tests_

Выбор шаблона файлов тестирования:

![Шаблон файлов тестов из папки тестов](img/test_04.png)

_Рисунок 125 — Шаблон файлов тестов из папки тестов_

После этого вы можете запускать ваши тесты:

![Запуск тестов](img/test_05.png)

_Рисунок 126 — Запуск тестов_
...
_Рисунок 127 — Открытая папка в VSCode_
...
_Рисунок 128 — Ввод команды `Python -m venv venv`_
...
_Рисунок 129 — Запрос на использование виртуальной среды_

![Отображение виртуальной среды](img/virtual_environment_04.png)

_Рисунок 130 — Отображение виртуальной среды_
...
_Рисунок 131 — Возможные варианты называния папки виртуальной среды_
...
_Рисунок 135 — Создание виртуальной среды_
...
_Рисунок 136 — Установка пути к виртуальным средам_
...
_Рисунок 137 — Выбор виртуальной среды_

![Выбранная виртуальная среда](img/virtual_environment_12.png)

_Рисунок 138 — Выбранная виртуальная среда_
...
_Рисунок 139 — Переназначение пути к Python_
...
_Рисунок 140 — Три проекта в одном окне_
...
_Рисунок 141 — Выбор проекта_

![Выбор виртуальной среды под проект](img/virtual_environment_16.png)

_Рисунок 142 — Выбор виртуальной среды под проект_
...
_Рисунок 143 — Выбор рабочей области_

![Выбор интерпретатора](img/virtual_environment_18.png)

_Рисунок 144 — Выбор интерпретатора_
...
_Рисунок 145 — Переключение виртуальных сред_
...
_Рисунок 146 — Открытие нового проекта в терминале_
...
_Рисунок 147 — Открытие нового проекта в терминале_
...
_Рисунок 148 — Выбор ввода пути виртуальной среды_
...
_Рисунок 149 — Ввод пути виртуальной среды_
...
_Рисунок 153 — Результат форматирования_
...
_Рисунок 156 — Результат форматирования_
...
_Рисунок 157 — Кнопка показа превью Markdown файла_
...
_Рисунок 158 — Markdown файл и его превью_

Попробуйте создать Markdown файл `test.md` с таким содержимым:
...
![Терминатор](img/terminator.svg)

![Пират](img/pirate.png)
...
_Рисунок 159 — Markdown файл с формулами и таблицей_

В папку `img` положите вот например такие рисунки:

![Тестовый рисунок `terminator`](img/terminator.svg)

_Рисунок 160 — Тестовый рисунок `terminator`_

![Тестовый рисунок `pirate`](img/pirate.png)

_Рисунок 161 — Тестовый рисунок `pirate`_
...
_Рисунок 163 — Кнопка открытия превью Markdown файла_
...
_Рисунок 164 — Кнопка открытия содержания Markdown файла_

![Превью Markdown файла с содержанием](img/markdown-preview-enhanced_03.png)

_Рисунок 165 — Превью Markdown файла с содержанием_
...
_Рисунок 166 — Контекстное меню_
...
_Рисунок 168 — Ошибки в документе_
...
_Рисунок 169 — Исправление таблицы_
...
_Рисунок 170 — Копирование из Excel в Markdown_
...
_Рисунок 171 — Кнопка Turn on Settings Sync_
...
_Рисунок 172 — Выбор синхронизируемых параметров_
...
_Рисунок 173 — Выбор версии VSCode_
...
_Рисунок 174 — Выбор аккаунта для авторизации_
...
_Рисунок 179 — Синхронизация настроек на втором компьютере_
