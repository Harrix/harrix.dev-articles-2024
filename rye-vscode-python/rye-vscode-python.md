...
_Рисунок 37 — Создание папки tests через правый клик в explorer_

В неё создайте файл, например, `test_main.py`:

![Созданный файл test_main.py](img/test_03.png)

_Рисунок 38 — Созданный файл test_main.py_
...
_Рисунок 40 — Успешный запуск тестов_
